...
WebUI.click(findTestObject('Object Repository/Page_Home - FIKA/span_Location'))

WebUI.click(findTestObject('Object Repository/Page_Location - FIKA/button_'))
...
WebUI.setText(findTestObject('Page_Location - FIKA/input_Search Code_p-inputtext p-component w-full'), 'inf')

WebUI.click(findTestObject('Object Repository/Page_Location - FIKA/button_Apply'))
...
for (int i = 1; i <= rowCount; i++) {
    ...
    String code = WebUI.getText(findTestObject('td_Dynamic', [('row') : i, ('col') : 2]))

    String name = WebUI.getText(findTestObject('td_Dynamic', [('row') : i, ('col') : 3]))

    WebUI.verifyMatch(departments, '.*Office.*', true)

    //WebUI.verifyEqual(code, 'Office')
    WebUI.verifyMatch(code, '.*Off.*', true)

    WebUI.verifyMatch(name, '.*Inf.*', true)
}
